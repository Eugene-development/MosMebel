        ...
        <div class="bg-gray-900 pt-6">
          <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
            ...
            <div class="hidden md:flex md:items-center md:space-x-4">
                <svg aria-hidden="true" class="h-8 w-8 text-white" fill="none" stroke="currentColor"
              ...
              <div class="text-3xl font-medium text-white flex">
                  8 (909) 299-53-13
              </div>
          ...
          <div class="mx-auto max-w-7xl lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:gap-8">
              <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                <div class="lg:py-24">
                  <div class="inline-flex items-center text-white bg-black rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200">
                    <span class="px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-gradient-to-r from-teal-500 to-cyan-600 rounded-full">Низкие цены</span>
                    <span class="ml-4 text-sm">ВЫСОКОЕ КАЧЕСТВО</span>
                  ...
                  <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                    <span class="block">Шкафы купе и кухонные гарнитуры</span>
                    <span class="pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">по вашим размерам</span>
                  </h1>
                  <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                    С учётом ваших пожеланий, размеров помещения и нашего богатого опыта более 20 лет мы обязательно что-то подберём для вас.
                  </p>
...
<!--                        </div>-->
                        <div class="mt-3 sm:mt-0">
                          <button type="submit" class="block w-full py-3 px-4 rounded-md shadow bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-medium hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-400 focus:ring-offset-gray-900">Оставьте заявку на бесплатный замер</button>
                        </div>
                      </div>
                      <p class="mt-3 text-sm text-gray-300 sm:mt-4">Возможна оплата транспортных расходов замерщика в размере до 500 рублей</p>
                    </form>
                  </div>
                </div>
              </div>
...
<!--                  <img class="w-full lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none" src="https://tailwindui.com/img/component-images/cloud-illustration-teal-cyan.svg" alt="">-->
      ...
      <footer id="test" class="bg-gray-50 " aria-labelledby="footer-heading">
